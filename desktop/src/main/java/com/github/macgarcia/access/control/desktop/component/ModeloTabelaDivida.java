 ...
 * @author macgarcia
 */
public class ModeloTabelaDivida extends AbstractTableModel {
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        return switch(columnIndex) {
            case 0 -> divida.getDescricao();
            case 1 -> divida.getValor();
            case 2 -> divida.getMes();
            case 3 -> divida.getCategoria();
            default -> throw new IllegalArgumentException("Erro interno na construção da tabela de dividas.");
        };
    }
